...
- code for metabolic percolation analysis by D.B.
- code for Figures (individually marked folders)
- read me and tables for trait based analysis (from Zoccarato et al 2022)
- link to raw data (Dryad)
